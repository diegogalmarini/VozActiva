...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-4 text-xs text-gray-300 relative z-10">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-white/10 border border-white/20 backdrop-blur-md hover:bg-white/20 transition-all"
            >
              {/* LinkedIn */}
              <svg viewBox="0 0 24 24" className="h-4 w-4 text-cyan-400" fill="currentColor" aria-hidden="true">
            ...
            >
              {/* GitHub */}
              <svg viewBox="0 0 24 24" className="h-4 w-4 text-gray-300" fill="currentColor" aria-hidden="true">
