        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-white/80 border border-white/40 backdrop-blur-md shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5"
            >
              {/* LinkedIn */}
            ...
            >
              {/* GitHub */}
              <svg viewBox="0 0 24 24" className="h-5 w-5 text-gray-900" fill="currentColor" aria-hidden="true">
